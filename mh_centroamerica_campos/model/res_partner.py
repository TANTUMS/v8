...
class res_partner(osv.osv):
    ...
    _columns = {
                ...
                'mh_shipping_name': fields.char(' Shipping Name'),
                'mh_shipping_street': fields.char(' Shipping Street'),
                'mh_shipping_numin': fields.char(' Shipping Num In'),
                'mh_shipping_ext': fields.char(' Shipping Num Ext'),
                'mh_shipping_colony': fields.char(' Shipping Colony'),
                'mh_shipping_zip': fields.char(' Shipping Zip'),
                'mh_shipping_city': fields.char('City'),
                'mh_shipping_state': fields.char(' Shipping State'),
                'mh_shipping_date': fields.date(' Shipping Date'),
                'mh_shipping_email': fields.char(' Shipping Email'),
                'mh_shipping_phone': fields.char(' Shipping Phone'),
                'mh_shipping_celphone': fields.char(' Shipping Cel Phone'),
                'mh_shipping_scheduler': fields.char(' Shipping Scheduler'),
                }
res_partner()